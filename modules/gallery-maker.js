export async function populateGalleryContainer(jsonData) {
  const galleryItemPromises = jsonData.map(obj => createGalleryItem(obj));
...
async function  createGalleryItem(obj) {
...
// On item click send indexing parameter to URL
