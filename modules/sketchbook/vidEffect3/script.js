...
function drawFromPixels(images, width, height) {
    ...
    const pixelManipulation = () => {
        ...
        // const selectedImgArr = mod.random(); // Jump around
        // const selectedImgArr = mod.rewind(); // Slit scan style
        // const selectedImgArr = mod.replay(200); // More slit scan
        // const selectedImgArr = mod.oscillate(); // horizontal noise

        for (let y = 0; y < height; y++) {
            // Modulations on y positions
            const selectedImgArr = mod.rewind(); // Slit scan style
            // const selectedImgArr = mod.replay(); // wild, use this on face features
            // const selectedImgArr = mod.random(); // horizontal noise
            ...
            for (let x = 0; x < width; x++) {
                ...
                // const selectedImgArr = mod.replay(); // Vertical ripple
