...
function drawFromPixels(images, width, height) {
    ...
    const pixelManipulation = () => {
        ...
        // const selectedImgArr = mod.random(); // Chunky slit scan
        // const selectedImgArr = mod.rewind(); // Is very laggy
        // const selectedImgArr = mod.replay(200); // Good random replaying effect
        // const selectedImgArr = mod.oscillate(); // horizontal noise

        for (let y = 0; y < height; y++) {
            // Modulations on y positions
            // const selectedImgArr = mod.rewind(); // Slit scan style
            // const selectedImgArr = mod.replay(20); // wild, use this on face features
            // const selectedImgArr = mod.random(); // Horizontal static
            // const selectedImgArr = mod.oscillate(); // ...
            ...
            for (let x = 0; x < width; x++) {
                ...
                const pixelIndex = (y * width + x) * 4; // RGBA data Covering the entire resolution
            
                // const selectedImgArr = mod.replay(); // Rotating and jumping
                const selectedImgArr = mod.rewind(); // Vertical slit scan style
    ...
    pixelManipulation(); // Start animation
};
